...
espregunta('Buena relación con la familia',X):- esrespuesta(X).
espregunta('Empatia con los demás ',X):- esrespuesta(X).
...
espregunta('Depresión y desesperanza',X):-esrespuesta(X).
...
main:-
        new(D,dialog('Mini Encuesta Neuropsiquiátrica')),
...
Elije la alternativa que coincida contigo.'))
        ...
        send_list(Ayuda, append,
                         [ menu_item(autores, message(@display, inform, 'Alfredo López Macías, Stefany Orea Herrera - Programación Lógica y Funcional - 8B'))
                         ]),
...
areaI(P1,_,_,P4,_,_,_,_,_,_):-
                                                  ...
                                                  espregunta('Depresión y desesperanza',P4),P4='si',
...
areaI(_,P2,P3,_,P5,_,P7,_,_,P10):-
                                                      ...
                                                      espregunta('Empatia con los demás ',P3),P3='si',
                                                      espregunta('Sociable',P5),P5='si',
                                                      espregunta('Buena relación con la familia',P7),P7='si',
                                                      espregunta('Valora lo que lo rodea',P10),P10='si',
                                                      pf3('D:/Escritorio/ProgLog/Programa/imagenes/bajo.jpg','Nivel bajo:
                                                      Por último, se puede hablar del suicidio consumado como el momento en el
                                                      cual la persona logró quitarse la vida.').
...
areaI(_,_,_,_,_,P6,_,P8,P9,_):-
                                                      ...
                                                      Al hablar de prevención del suicidio es importante conceptualizar la conducta
                                                      ...
                                                      cual si se actúa de forma oportuna se puede prevenir').
...
pf3(X,Y):-new(D,dialog('RESULTADOS DE LA Mini Encuesta Neuropsiquiátrica ')),
          mostrar2(X,D,20,30),
           new(L,label(n,'')),
